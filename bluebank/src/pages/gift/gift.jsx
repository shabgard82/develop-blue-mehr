...
function Reward() {
  ...
  return (
    <Stack>
      ...
      <Stack display="flex" direction="column" className={styles.location}>
        <Stack
          display="flex"
          direction="row"
        ...
        <Stack pl={3} pt={1} pb={1}>
          <Button
            variant="contained"
            sx={{backgroundColor:'#cce6ff',boxShadow:"none",color:'blueviolet', width: 80, padding: 1, fontWeight: "600" }}
          >
            Active
          </Button>
        </Stack>
      </Stack>
      <Stack overflow-y="auto" height="400px"></Stack>
    </Stack>
  );
}
