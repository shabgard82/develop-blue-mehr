  ...
  return (
    <>
      ...
      >
        ...
        <Stack pl={2} pr={2} pt={4} display="flex" direction="row" alignItems="center" justifyContent='space-between'>
        ...
        <Stack pl={2} pr={2} pt={2} display="flex" direction="row" alignItems="center" justifyContent='space-between'>
